...
- Version bump 3.2.53 → 3.2.54, fixed stale Version History Latest entry (v3.2.51→v3.2.54), ecosystem documentation consistency audit.
...
- Repo maintenance: Audit completed, verified version consistency across all files, confirmed ecosystem cross-references are intact across all 6 AliDujie skills. Version bump 3.2.30→3.2.31.
...
- Version sync: align SKILL.md and CHANGELOG with pyproject.toml/README badge (3.2.28)

## [3.2.27] - 2026-06-02

- Repo maintenance: Version bump to 3.2.27, ecosystem cross-reference audit across all 6 AliDujie skills.
...
- Version bump to 3.1.93 across README/SKILL.md/pyproject.toml/__init__.py
...
- Repo maintenance: add cross-skill reference sections to key reference docs (05-research-methods.md, 06-analysis-framework.md), expand ecosystem collaboration coverage
